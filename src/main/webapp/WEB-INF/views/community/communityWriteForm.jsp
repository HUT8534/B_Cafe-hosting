...
<head>
<meta charset="UTF-8">
<title>communityWriteForm.jsp</title>
	...
	<div class="sub_content" id="contents">
		<div class="sub-visual" style="background-image: url('${contextPath}/resources/imageFile/banner4.png')">
			<div class="sub-visual__wrapper container">
				...
				<p class="sub-visual__txt wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">커뮤니티 게시글을 작성할 수 있는 공간입니다</p>
			</div>
		</div>
		...
		<div class="sub-con">
			<div class="wrap community">
				<div class="write_save">
					<form action="${contextPath }/community/writeSave" enctype="multipart/form-data" method="post">
						<b> 작성자 </b><br> <input type="text" name="userId" value="${loginUser }" readonly><br> 
						<b> 제 목 </b><br>
						<input type="text" name="communityTitle" size="50" maxlength="25" placeholder="25자 이내 작성"><br>
						<b> 내 용 </b><br>
						<textarea rows="10" cols="50" id="communityContent" name="communityContent" maxlength="500" placeholder="500자 이내 작성"></textarea>
						<br> 
						<b class="textCount">0자</b><b class="textTotal">/500자</b>	
						<br> 
						<input type="submit" value="글 작성">&nbsp; 
						<input type="button" value="글목록" onclick="location.href='${contextPath}/community/communityAllList'">
					</form>
				</div>
			</div>
		</div>
