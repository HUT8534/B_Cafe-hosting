...
<h1 class="sub-visual__title wow fadeInDown" style="visibility: visible; animation-name: fadeInDown;">Q & A</h1>
				<p class="sub-visual__txt wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">게시글을 작성 할 수 있는 공간입니다</p>
			</div>
		</div>
		...
		<div class="sub-con">
			<div class="wrap qna">
				<div class="write_save">
					<form action="${contextPath }/qna/writeSave" enctype="multipart/form-data" method="post">
						<b> 작성자 </b><br> 
						<input type="text" name="userId" value="${loginUser }" readonly><br> 
						<b> 제 목 </b><br>
						<input type="text" name="qnaTitle" size="50"><br> 
						<b> 내 용 </b><br>
						<textarea rows="10" cols="50" name="qnaContent"></textarea>
						<br><br>
